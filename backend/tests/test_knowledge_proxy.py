...
These tests pin the forwarding so that regression cannot come back.
"""
...
def test_create_is_forwarded_to_core():
    ...
    expected = {"id": "doc-1", "title": "产品手册", "chunks": 4, "created_at": "2026-08-12T02:00:00"}
    ...
    assert kwargs["timeout"] > 120  # embedding many chunks outlasts the MCP default
...
def test_proxy_drops_absent_form_fields():
